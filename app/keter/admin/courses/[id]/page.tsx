      ...
      <KeterRouteGuard allowedRoles={["ADMIN", "MANAGER"]}>
        <AdminLayout>
          <div className="text-center py-20">
            ...
            <Button variant="secondary" onClick={() => router.push("/keter/admin/courses")} className="mt-4">
              Back to Courses
            </Button>
          </div>
        </AdminLayout>
          ...
          <div>
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <Button variant="secondary" onClick={() => router.push(`/keter/admin/courses/${courseId}/preview`)}>
                  <Eye className="w-4 h-4 mr-2" />
                  Preview Course
                </Button>
                <Button variant="primary" onClick={() => router.push(`/keter/admin/courses/${courseId}/edit`)}>
