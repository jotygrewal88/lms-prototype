...
import SlideFrame from "@/components/keter/learner/player/SlideFrame";
...
export default function CoursePlayerPage() {
  ...
  // Skills earned on course completion — derived from the course's
  // skill metadata. The original page hardcoded "LOTO Certified" /
  // "Lockout/Tagout" chips; the Keter clone reads them dynamically so
  // the Anderson Plant Injection Molding course never displays LOTO
  // chips on its completion screen.
  const earnedSkills = getSkillsByCourseId(course.id);
