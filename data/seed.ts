...
export const users: User[] = [
  ...
  // Passwordless login prototype: floor workers who sign in with Employee ID + PIN.
  // No email address; managed entirely by admins. Mixed login states (see directory).
  {
    id: "usr_pwl_1",
    firstName: "Rosa",
    lastName: "Delgado",
    email: "",
    role: "LEARNER",
    jobTitleText: "Production Floor Associate",
    siteId: "site_a",
    departmentId: "dept_a_packaging",
    managerId: "usr_mgr_a_pkg",
    active: true,
  ...
  },
  {
    ...
    email: "",
    role: "LEARNER",
    jobTitleText: "Maintenance Helper",
    siteId: "site_a",
    departmentId: "dept_a_maintenance",
    managerId: "usr_mgr_a",
    active: true,
